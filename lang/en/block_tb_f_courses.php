...
/**
 * Lang strings for tb_f_courses block
 *
...
$string['tb_f_courses:addinstance'] = 'Add a new Leeloo LXP Featured Courses block';
$string['tb_f_courses:myaddinstance'] = 'Add a new Leeloo LXP Featured Courses block to Dashboard';
$string['defaultmaxcourses'] = 'Default maximum courses';
$string['defaultmaxcoursesdesc'] = 'Maximum courses which should be displayed on Leeloo LXP Featured Courses block, 0 will show all courses';
...
$string['pluginname'] = 'Leeloo LXP Featured Courses';
$string['displayname'] = 'Leeloo LXP Featured Courses';
...
$string['tb_f_courses_bgimage'] = "Embed images into background";
$string['tb_f_courses_bgimage_desc'] = "This will embed images into background as a CSS property";
...
$string['privacy:metadata'] = 'The Leeloo LXP Featured Courses (tb_f_courses) block only shows information about courses and does not store data itself.';

$string['blocktitle'] = 'Leeloo LXP Featured Courses';
